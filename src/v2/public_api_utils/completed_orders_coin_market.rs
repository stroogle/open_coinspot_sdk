...
mod tests {
    ...
    async fn test_completed_orders_coin_market() {
        ...
        result = PublicUtils::completed_orders_coin_market("btc", "usdt")
        .await
        .unwrap();
    ...
    async fn test_completed_orders_fake_coin_market() {
        let result2 = PublicUtils::completed_orders_coin_market("sdfsdf", "usdt")
        .await
        .unwrap();
    ...
    async fn test_completed_orders_fake_market() {
        let result2 = PublicUtils::completed_orders_coin_market("btc", "usdt123")
        .await
        .unwrap();
